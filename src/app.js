...
(function() {
  var LevelStore, app, authCheck, bodyparser, express, levelup, metrics, morgan, session, users;
  ...
  app.post('/my-metrics', authCheck, function(req, res) {
    ...
    return metrics.save(req.session.user, myDate2.getTime(), req.body.value, function(err, data) {
      if (err) {
        throw error;
      } else {
        return res.render('my_metrics');
  ...
  app.get('/metrics.json', function(req, res) {
    return metrics.get(req.session.user, function(err, data) {
      return res.status(200).json(data);
    });
  });

  app.post('/metrics/:id.json', authCheck, function(req, res) {
